                ...
                <button class="btn btn-default" type="button"><i class="fa fa-search"></i></button>
                    ...
                    <ul class="media-list media-list-contacts">
                        ...
                        <li class="media">
                            <a href="#">
                                <div class="media-left">
                                    <img class="media-object img-circle" src="{{ asset('images/photos/user4.png') }}" alt="">
                                </div>
                                <div class="media-body">
                        ...
                        <li class="media">
                            <a href="#">
                                <div class="media-left">
                                    <img class="media-object img-circle" src="{{ asset('images/photos/user5.png') }}" alt="">
                                </div>
                                <div class="media-body">
                        ...
                        <li class="media">
                            <a href="#">
                                <div class="media-left">
                                    <img class="media-object img-circle" src="{{ asset('images/photos/user6.png') }}" alt="">
                                </div>
                                <div class="media-body">
                        ...
                        <li class="media">
                            <a href="#">
                                <div class="media-left">
                                    <img class="media-object img-circle" src="{{ asset('images/photos/user7.png') }}" alt="">
                                </div>
                                <div class="media-body">
                        ...
                        <li class="media">
                            <a href="#">
                                <div class="media-left">
                                    <img class="media-object img-circle" src="{{ asset('images/photos/user8.png') }}" alt="">
                                </div>
                                <div class="media-body">
                        ...
                        <li class="media">
                            <a href="#">
                                <div class="media-left">
                                    <img class="media-object img-circle" src="{{ asset('images/photos/user9.png') }}" alt="">
                                </div>
                                <div class="media-body">
                        ...
                        <li class="media">
                            <a href="#">
                                <div class="media-left">
                                    <img class="media-object img-circle" src="{{ asset('images/photos/user10.png') }}" alt="">
                                </div>
                                <div class="media-body">
